...
assert os.path.exists('/opt/ros/jade')
...
# default configuration generated by pyros_setup.jade
# Usage from python :
# import pyros_setup
...
def activate():
    ...
    ROS_emulate_setup('jade', *_config_handler.config['WORKSPACES'])
