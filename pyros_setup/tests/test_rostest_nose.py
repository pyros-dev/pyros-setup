...
# this test is used to validate pyros_setup/rostest_nose behavior if imported after delayed import
...
# this test is used to validate pyros_setup/rostest_nose behavior if imported before delayed import
...
# this test is only to validate pyros_setup/rostest_nose compatibility with rostest
# It is written following rostest style
@nose.tools.nottest
class testRosTest(unittest.TestCase):
    def test_rostest_detection(self):
        # check that pyros_setup/rostest_nose is usable even without delay import magic
        from pyros_setup import rostest_nose
        import rosnode
...
if __name__ == '__main__':
    ...
    from pyros_setup import rostest_nose
    rostest_nose.rostest_or_nose_main('pyros_setup', 'testRosTest', testRosTest, sys.argv)
